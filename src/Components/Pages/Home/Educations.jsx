...
const Educations = () => {
    return (
        <motion.div  drag
        dragConstraints={{left: 0, top: 0, right:0 , bottom: 0}} className="  bg-white  shadow-md rounded-lg   col-span-2  duration-700 hover:shadow-lg border hover:scale-105 relative ">
