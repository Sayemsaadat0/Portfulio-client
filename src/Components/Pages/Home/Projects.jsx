...
const Projects = () => {
    return (
        <motion.div drag className="dark:bg-[#1E1E1E] bg-white  shadow-md rounded-lg col-span-2 row-span-2 overflow-hidden  duration-700 hover:shadow-lg border hover:scale-105">
