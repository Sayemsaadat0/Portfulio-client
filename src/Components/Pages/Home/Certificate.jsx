            ...
            <div className='md:py-4 px-2 flex justify-center items-center flex-col'>
                <div>
                    ...
                    <div className='group items-center justify-center '>
                        <a className='text-xs flex  justify-center items-center gap-1 hover:bg-black hover:text-white duration-700 mt-3 rounded-full py-2 px-3 border  ' download={true} href="/certificate.pdf">Certificate
